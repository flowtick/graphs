...
final case class StyleSheet(id: Option[String] = None,
                            ...
                            edgeDefault: Option[EdgeShape] = None) extends StyleSheetLike {
...
final case class StyleSheets(styleSheets: List[StyleSheet]) extends StyleSheetLike {
  ...
  private def updateFirstSheet(filter: StyleSheet => Boolean)(update: StyleSheet => StyleSheet): StyleSheets = {
  ...
  override def updateNodeStyle(id: String, nodeShape: Option[NodeShape] => Option[NodeShape]): StyleSheetLike =
    updateFirstSheet(_.nodeStyles.overrides.exists(_.contains(id)))(_.updateNodeStyle(id, nodeShape))

  override def updateEdgeStyle(id: String, edgeShape: Option[EdgeShape] => Option[EdgeShape]): StyleSheetLike =
    updateFirstSheet(_.edgeStyles.overrides.exists(_.contains(id)))(_.updateEdgeStyle(id, edgeShape))

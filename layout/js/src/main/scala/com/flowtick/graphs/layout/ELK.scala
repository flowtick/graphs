...
class ElkLayoutNode(
    ...
    val width: Double,
    val height: Double,
    val children: js.Array[ElkLayoutNode] = js.Array.apply()
) extends js.Object
...
class ElkLayoutEdge(
    ...
    val sections: js.Array[ElkLayoutEdgeSection] = js.Array.apply()
) extends js.Object

@JSExportTopLevel("ElkLayoutGraph")
class ElkLayoutGraph(
    val id: String,
    val layoutOptions: js.Dictionary[js.Any] = js.Dictionary.apply(
      "elk.algorithm" -> "layered"
    ),
    val children: js.Array[ElkLayoutNode] = js.Array(),
    val edges: js.Array[ElkLayoutEdge] = js.Array()
) extends js.Object {
